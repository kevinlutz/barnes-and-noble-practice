export const books = [
  ...
  },
  {
    ...
    reviews: [{ user_id: 15, content: "good way to learn JQuery", rating: 4 }],
  },
  {
    ...
    reviews: [
      ...
      { user_id: 250, content: "Only JS book anyone needs", rating: 4 },
    ],
  },
  {
    ...
    genre: "technical",
    image:
      "https://images-na.ssl-images-amazon.com/images/I/51wijnc-Y8L._SX218_BO1,204,203,200_QL40_FMwebp_.jpg",
    description:
      "JavaScript is the programming language of the web and is used by more software developers today than any other programming language. For nearly 25 years this best seller has been the go-to guide for JavaScript programmers. The seventh edition is fully updated to cover the 2020 version of JavaScript, and new chapters cover classes, modules, iterators, generators, Promises, async/await, and metaprogramming. You’ll find illuminating and engaging example code throughout.",
    reviews: [
      { user_id: 44, content: "Great intro to js book", rating: 4 },
      { user_id: 350, content: "It really is the Definitive guide", rating: 5 },
    ],
  },
  {
    ...
    genre: "technical",
    image:
      "https://images-na.ssl-images-amazon.com/images/I/41T5H8u7fUL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg",
    description:
